...
class MyApp:
    ...
    def create_grid(self):
        ...
        lbl_caffenated_drinks= tk.Label(master=self.frame, text="Number of caffenated drinks", font=("Helvectica",25), bg='#140096', fg='white')

        # button
        button = Button(self.frame, text="Get my Sleep Score!", font=("Helvetica", 25), bg='white', fg='#140096', command= self.increase)

        rec_sleep_btn = Button(self.frame, text="Sleep Recommendation", font=("Helvetica", 25), bg='white', fg='#140096', command= self.recommend)
        # grid of the frame
    ...
    def recommend(self):
        ...
        # labels for second frame
        lbl_text_title = tk.Label(master=self.frame, text="Your sleep quality card", font=("Helvetica", 40), bg='#140096', fg='white')
        empty_text = tk.Label(master=self.frame, text="", bg='#140096', fg='#140096')
        lbl_previous_night_sleep_score = tk.Label(master=self.frame, text="Previous night sleep score: ", font=("Helvetica", 25), bg='#140096', fg='white')
        self.sleep_score = tk.Entry(master=self.frame, fg="white", bg="#140096", width=20, font = ('Helvetica', 15))

        btn_recommend = Button(self.frame, text="Get Recommendation", font=("Helvetica", 25), bg='white', fg='#140096', command= self.ga)
        # lbl_sleep_score = tk.Label(master=self.frame, text="Your sleep score:", font=("Helvetica", 25), bg='#140096', fg='white')
        # lbl_time_bed = tk.Label(master=self.frame, text="You need at least that time in bed:", font=("Helvetica", 25), bg='#140096', fg='white')
    ...
    def ga(self):
        ...
        lbl_sleep = tk.Label(master=self.frame, text="We recommend you: ", font=("Helvetica", 25), bg='#140096', fg='white')
