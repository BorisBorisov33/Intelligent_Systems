...
class MyApp:
    ...
    def create_grid(self):
        # entries
        self.time_in_bed = tk.Entry(master=self.frame, fg="white", bg="#e28743", width=20, font = ('Helvetica', 15))
        ...
        # labels
        self.lbl_title = tk.Label(master=self.frame, text="Please input your details", font=("Helvetica", 40), bg='#e28743', fg='white')
        ...
        # position of entries
        self.time_in_bed.grid(row=2, column=1, padx=10, pady=10)
    ...
    def increase(self):
        self.lbl_title['text'] = "Something else"
